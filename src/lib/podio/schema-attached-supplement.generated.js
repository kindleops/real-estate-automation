  ...
  [String(APP_IDS.message_events)]: {
    ...
    fields: {
      ...
      "category": {
        ...
        referenced_app_ids: [],
        options: [
          { id: 1, text: "Seller Inbound SMS" },
          { id: 2, text: "Seller Outbound SMS" },
          { id: 3, text: "Delivery Update" },
          { id: 4, text: "Send Failure" },
          { id: 5, text: "Stage Transition" },
          { id: 6, text: "AI Classification" },
          { id: 7, text: "Manual Note" },
        ],
      },
      "text-2": {
      ...
      "failure-bucket": {
        ...
        multiple: false,
        options: [
          { id: 1, text: "Carrier Rejection" },
          { id: 2, text: "Undelivered" },
          { id: 3, text: "Rate Limited" },
          { id: 4, text: "Invalid Number" },
          { id: 5, text: "Opt Out / DNC" },
          { id: 6, text: "Timeout" },
          { id: 7, text: "System Error" },
          { id: 8, text: "Other" },
        ],
      },
      "processed-by": {
        ...
        multiple: false,
        options: [
          { id: 1, text: "Manual Sender" },
          { id: 2, text: "GPT-4o AI" },
          { id: 3, text: "Mistral-7B AI" },
          { id: 4, text: "Autoresponder" },
          { id: 5, text: "Drip Campaign" },
          { id: 6, text: "Scheduled Campaign" },
          { id: 7, text: "Queue Runner" },
          { id: 8, text: "Send Now API" },
        ],
      },
      "source-app": {
        ...
        multiple: false,
        options: [
          { id: 1, text: "Send Queue" },
          { id: 2, text: "External API" },
          { id: 3, text: "Manual" },
          { id: 4, text: "Conversation Brain" },
          { id: 5, text: "Workflow Automation" },
        ],
      },
    },
  },
    ...
    fields: {
      ...
      "category-5": {
        ...
        options: [
          ...
          { id: 4, text: "Novation" },
          { id: 5, text: "Lease Option" },
          { id: 6, text: "Hybrid" },
          { id: 7, text: "Nurture" },
          { id: 8, text: "DNC" },
          { id: 9, text: "Wrong Number" },
          { id: 10, text: "Unknown" },
        ],
      },
      // ── Overrides for base-schema fields with stale options ───────────────
      ...
      "seller-profile": {
        ...
        options: [
          ...
          { id: 6, text: "Divorced" },
          { id: 7, text: "Vacant Owner" },
          { id: 8, text: "Absentee" },
          { id: 9, text: "Code Violation" },
          { id: 10, text: "Tax Lien" },
          { id: 11, text: "Corporate" },
          { id: 12, text: "Unknown" },
        ],
      },
      "language-preference": {
